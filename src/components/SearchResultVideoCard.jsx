          ...
          <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
              ...
              <div className="hidden md:flex items-center">
                  ...
                  <div className="flex flex-col">
                      <span className='text-sm font-semibold mt-2 text-white/[0.7] flex items-center'>    {video?.author?.title}
                      ...
                      <div className="flex text-sm font-semibold text-white/[0.7] truncate overflow-hidden">
                        ...
                        <span className='flex text-[24px] leading-none font-bold text-white/[0.7] relative top-[-9px] mx-1'>.</span>
